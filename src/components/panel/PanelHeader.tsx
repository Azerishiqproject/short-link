    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        {typeof balance === 'number' && (
          <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800/50">
            <span className="text-sm text-slate-600 dark:text-slate-300">Bakiye</span>
            <span className="text-sm font-semibold text-slate-900 dark:text-white">₺{balance.toLocaleString()}</span>
          </div>
        )}
