  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Link Yönetimi</h2>
          <p className="text-slate-600 dark:text-slate-400 mt-1">Linklerinizi oluşturun, düzenleyin ve analiz edin</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="px-3 py-1.5 bg-slate-100 dark:bg-slate-700 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300">
            {links.length} link
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex gap-3">
              <input
                className="flex-1 h-11 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white px-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
      ...
      <div>
        {links.length === 0 ? (
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-12 text-center">
            ...
            <h4 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Henüz link yok</h4>
            <p className="text-slate-600 dark:text-slate-400">Yukarıdaki formdan yeni link oluşturun</p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-12 text-center">
            ...
            <h4 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Arama sonucu bulunamadı</h4>
            <p className="text-slate-600 dark:text-slate-400">Farklı bir arama terimi deneyin</p>
          </div>
        ) : (
          <div className="space-y-3">
            {filteredLinks.map((link) => (
              <div key={link._id} className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 hover:shadow-md transition-all duration-200">
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="font-mono text-sm bg-slate-100 dark:bg-slate-700 px-3 py-1.5 rounded-lg text-slate-800 dark:text-slate-200 border">
                        /r/{link.slug}
                      </div>
                    ...
                    <div className="text-sm text-slate-600 dark:text-slate-400 break-all mb-3 bg-slate-50 dark:bg-slate-700/50 p-3 rounded-lg border">
                      {link.targetUrl}
                    </div>
                  ...
                  <div className="flex items-center gap-2 ml-4">
                    <Button
                      ...
                      className="bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 text-xs px-3 py-1.5"
                    >
                    ...
                    >
                      ...
                      {link.disabled ? 'Aktifleştir' : 'Pasifleştir'}
                    </Button>
                    ...
                    <Button
                      ...
                      className="bg-red-50 dark:bg-red-950/30 text-red-700 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-950/50 border-red-200 dark:border-red-800 text-xs px-3 py-1.5"
                    >
                      <svg className="w-3 h-3 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {editingLink?._id === link._id && (
                  <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                    <div className="flex gap-3">
                      <input
                        className="flex-1 h-10 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
                        value={editUrl}
                      ...
                      <Button 
                        ...
                        className="bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 text-xs px-4"
                      >
                        İptal
                      </Button>
                    </div>
            ...
            <div className="p-6 border-b border-slate-200 dark:border-slate-700">
              <div className="flex items-center justify-between">
                ...
                <Button 
                  ...
                  className="bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 p-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4 text-center">
                      <div className="text-2xl font-bold text-slate-900 dark:text-white">{analytics.totalClicks}</div>
